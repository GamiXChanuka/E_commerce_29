...
// -------------------------------------------------------------------------------------------------
    ...
    <section className="py-8 antialiased bg-gray-200 dark:bg-gray-900 md:py-12">
      <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ml-2">
                      Products
                    </a>
                  </div>
                </li>
                <li aria-current="page">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2">Electronics</span>
                  </div>
                </li>
              </ol>
            </nav>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          {loading ? (
            ...
            products.map((product) => (
              <div key={product.ProductID} className="m-4 transition-transform duration-300 transform bg-white rounded-lg shadow-lg hover:scale-105 dark:bg-gray-50 dark:border-gray-600 dark:text-gray-300">
                <figure>
                  <img
                    src={product.image_link}
                    alt={product.Title}
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-center mt-2">
                    <button className="px-3 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700">
                      <Link href={`/marketplace/${product.ProductID}`} >Add to Cart</Link>
                    </button>
                  </div>
                </div>
              </div>
