...
function AboutUs() {
  return (
    <ParallaxProvider>
      {/* Breadcrumbs */}
      <div className="px-5 sm:px-10 bg-gradient-to-r from-gray-900 to-gray-700 text-white py-4 shadow-md">
      ...
      <Parallax speed={-20}>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-300 to-gray-100 opacity-70"></div>
          <motion.div className="relative text-center text-black z-10 px-4 sm:px-0">
            <motion.h1
            ...
            <motion.a
              href="#journey"
              className="inline-block mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:scale-105 hover:shadow-2xl transition-transform duration-300"
              initial={{ scale: 0.95 }}
              animate={{ scale: 1 }}
      ...
      <Parallax speed={10}>
        <section 
          id="values" 
          className="bg-gradient-to-r from-blue-900 to-blue-100 py-16 sm:py-20 px-5 sm:px-10"
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1581092337807-d047577e9480')`, backgroundSize: 'cover' }}
        >
          <div className="container mx-auto text-center text-white">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 sm:mb-8 text-black">Our Core Values</h2>
      ...
      {/* Contact Us Section */}
      <section 
        className="bg-gradient-to-r from-blue-900 to-blue-100 text-blue-900 py-16 sm:py-20 px-5 sm:px-10"
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <motion.a
            ...
            className="inline-block mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-700 font-semibold rounded-lg hover:bg-gray-200 transition-transform duration-300 hover:scale-105 shadow-xl"
