  ...
  return (
    <div className="relative flex items-center">
      <input
        ...
        className="h-12 pl-5 text-sm text-white placeholder-white transition-all duration-300 ease-in-out transform bg-gray-400 rounded-full shadow-lg min-w-48 pr-14 focus:outline-none focus:ring-2"
      />
      <svg
